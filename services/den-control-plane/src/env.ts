...
const schema = z.object({
  ...
  RENDER_WORKER_OPENWRK_VERSION: z.string().optional(),
...
export const env = {
  ...
  render: {
    ...
    workerRepo: parsed.RENDER_WORKER_REPO ?? "https://github.com/different-ai/openwork-enterprise",
    workerBranch: parsed.RENDER_WORKER_BRANCH ?? "main",
    ...
    workerOpenwrkVersion: parsed.RENDER_WORKER_OPENWRK_VERSION ?? "0.11.22",
