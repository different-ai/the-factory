...
8. Once the PR exists, upload screenshots/videos to Supabase and embed the returned public URLs in the PR body. Use inline Markdown images for screenshots. For videos, embed an uploaded GIF preview inline and keep the full MP4 as a link below it (only if relevant in the UI).
